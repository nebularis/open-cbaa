# WIM Design Review (CBAA Modules M1–M14)

This review assessed the first, structural WIM ontology (the flat `ontology/lma-wim` modules,
since replaced) against the CBAA module drafts, and proposed the further strata. Its outcome
is the [design specification](design-spec.md), and the ontologies now in
[`ontology/`](../../ontology/README.md) implement that. It is kept as the record of why.
...
([§3](design-spec.md#3-what-a-clause-expresses)), vocabulary tiers and scoped binding
([§4](design-spec.md#4-vocabulary)), and quantification taken from LATTICE
([§5](design-spec.md#5-quantification-evaluation-of-lattice)).
