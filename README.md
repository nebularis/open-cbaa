...
- `docs/design/` — the [design specification](docs/design/design-spec.md), the [LATTICE integration specification](docs/design/lattice-integration.md), the [LATTICE design review](docs/design/design-review.md), the [WIM design review](docs/design/wim-review.md), the [vision and demo ideation](docs/design/ideation.md). Perils, exposure, contract terms and the MORK bridge between drafter or market peril lists and the reference are designed in LATTICE's [applied insurance reference epic](https://github.com/nebularis/lattice/blob/main/docs/developer/plans/applied-insurance-reference.md), which Open CBAA binds
