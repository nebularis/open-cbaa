...
- `ontology/` — normative OWL 2 ontology sources, their [README](ontology/README.md), the [design specification](docs/design/design-spec.md), the [LATTICE integration specification](docs/design/lattice-integration.md) and the [LATTICE design review](docs/design/design-review.md)
